...
EgmProtobufWin::EgmProtobufWin(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::EgmProtobufWin)
{
    ui->setupUi(this);
    auto title = QString::fromLocal8Bit("Code By @%1").arg(AUTHOR);
    setWindowTitle(title);
    m_udp1 = new QUdpSocket();
    m_udp2 = new QUdpSocket();
    connect(this, &EgmProtobufWin::appendUdpLog1, this, &EgmProtobufWin::onAppendUdpLog1);
    connect(this, &EgmProtobufWin::appendUdpLog2, this, &EgmProtobufWin::onAppendUdpLog2);
    connect(m_udp1, &QUdpSocket::readyRead, this, &EgmProtobufWin::onUdp1ReadPendingData);
    connect(m_udp2, &QUdpSocket::readyRead, this, &EgmProtobufWin::onUdp2ReadPendingData);
}

EgmProtobufWin::~EgmProtobufWin()
{
    delete ui;
    m_udp1->deleteLater();
    m_udp2->deleteLater();
...
void EgmProtobufWin::onAppendUdpLog1(const QString &log)
{
    if(log.isEmpty())
    {
        return;
...
void EgmProtobufWin::onAppendUdpLog2(const QString &log)
{
    if(log.isEmpty())
    {
        return;
...
void EgmProtobufWin::onUdp1ReadPendingData()
{
...
void EgmProtobufWin::onUdp2ReadPendingData()
{
...
void EgmProtobufWin::on_btnUdpUnbind1_clicked()
{
    m_udp1->abort();
...
void EgmProtobufWin::on_btnUdpBind1_clicked()
{
...
void EgmProtobufWin::on_btnSendUdp1EgmData_clicked()
{
    if(!m_udp1->isValid())
    {
...
void EgmProtobufWin::on_btnSendUdp1_clicked()
{
...
void EgmProtobufWin::on_btnUdpUnbind2_clicked()
{
    m_udp2->abort();
...
void EgmProtobufWin::on_btnUdpBind2_clicked()
{
...
void EgmProtobufWin::on_btnSendUdp2EgmData_clicked()
{
    if(!m_udp2->isValid())
    {
...
void EgmProtobufWin::on_btnSendUdp2_clicked()
{
...
void EgmProtobufWin::createEgmSensorMsg(EgmSensor *sensorMsg)
{
    // 信息头
...
void EgmProtobufWin::createEgmRobotMsg(EgmRobot *robotMsg)
{
    // 信息头
    EgmHeader *header = new EgmHeader();
